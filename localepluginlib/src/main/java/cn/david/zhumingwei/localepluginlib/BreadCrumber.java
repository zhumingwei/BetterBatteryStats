...
package cn.david.zhumingwei.localepluginlib;

import android.content.Context;
import android.content.Intent;
import android.util.Log;
import cn.david.zhumingwei.localepluginlib.R;
...
public final class BreadCrumber
{
     ...
     * including right-to-left languages, as long as the proper
     * {@link com.twofortyfouram.locale.platform.R.string#twofortyfouram_locale_breadcrumb_format} string resources have been
     * created.
     *
     ...
     */
    public static CharSequence generateBreadcrumb(final Context context, final Intent intent, final String currentCrumb)
    {
        if (null == context)
        {
        ...
        try
        {
             ...
             */
            final String breadcrumbString = intent.getStringExtra(cn.david.zhumingwei.localepluginlib.Intent.EXTRA_STRING_BREADCRUMB);
            if (null != breadcrumbString)
            {
                return context.getString(
                        R.string.twofortyfouram_locale_breadcrumb_format, breadcrumbString, context.getString(R.string.twofortyfouram_locale_breadcrumb_separator), currentCrumb);
            }
            return currentCrumb;
        }
