...
package cn.david.zhumingwei.betterbatterystats.localeplugin.ui;
...
import cn.david.zhumingwei.betterbatterystats.adapters.ReferencesAdapter;
...
import cn.david.zhumingwei.localepluginlib.BreadCrumber;
...
public final class EditActivity extends Activity
{
    ...
    /**
     * Help URL, used for the {@link cn.david.zhumingwei.localepluginlib.platform.R.id#twofortyfouram_locale_menu_help} menu item.
     */
     ...
     * {@link cn.david.zhumingwei.localepluginlib.platform.R.id#twofortyfouram_locale_menu_dontsave} menu item in
     ...
     * {@link cn.david.zhumingwei.localepluginlib.Intent#EXTRA_BUNDLE} and {@link cn.david.zhumingwei.localepluginlib.Intent#EXTRA_STRING_BLURB}.
     * <p>
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        BundleScrubber.scrub(getIntent().getBundleExtra(cn.david.zhumingwei.localepluginlib.Intent.EXTRA_BUNDLE));
        ...
        {
            final Bundle forwardedBundle = getIntent().getBundleExtra(cn.david.zhumingwei.localepluginlib.Intent.EXTRA_BUNDLE);
...
//                ((Spinner) findViewById(R.id.spinnerStatType)).setSelection(forwardedBundle.getInt(PluginBundleManager.BUNDLE_EXTRA_INT_POSITION));
    ...
    public void finish()
    {
        ...
        else
        {
            ...
            resultIntent.putExtra(cn.david.zhumingwei.localepluginlib.Intent.EXTRA_BUNDLE, resultBundle);
            
            // add text for display in tasker
            resultIntent.putExtra(cn.david.zhumingwei.localepluginlib.Intent.EXTRA_STRING_BLURB, "Stat Type: " + ref);
    ...
    public boolean onCreateOptionsMenu(final Menu menu)
    {
         ...
         */
        getMenuInflater().inflate(cn.david.zhumingwei.localepluginlib.R.menu.twofortyfouram_locale_help_save_dontsave, menu);
    ...
    public boolean onMenuItemSelected(final int featureId, final MenuItem item)
    {
        ...
        if (id == cn.david.zhumingwei.localepluginlib.R.id.twofortyfouram_locale_menu_help)
        {
            try
            {
            ...
            {
                Toast.makeText(getApplicationContext(), cn.david.zhumingwei.localepluginlib.R.string.twofortyfouram_locale_application_not_available, Toast.LENGTH_LONG).show();
            }

            return true;
        }
        else if (id == cn.david.zhumingwei.localepluginlib.R.id.twofortyfouram_locale_menu_dontsave)
        {
            mIsCancelled = true;
            finish();
            return true;
        }
        else if (id == cn.david.zhumingwei.localepluginlib.R.id.twofortyfouram_locale_menu_save)
        {
            finish();
            return true;
        }
